...
## Computer-Mediated Communication / 计算机媒介沟通
...
## Multi-Person Coordination / 多人协调与博弈
...
## Context Materials for Satirical Scene-Building / 用于戏谑场景建构的语境材料

The social-media motifs folded into the paper are treated as interpretive scene language rather than formal evidence. They were drawn from:

- contemporary Weibo discussion in which MBTI is used as a folk vocabulary for team roles and work styles
- Xiaohongshu discourse that treats MBTI as social shorthand and “relationship language”
